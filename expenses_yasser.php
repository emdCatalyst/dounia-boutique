...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_expense'])) {
    ...
    header("Location: expenses_yasser.php?start_date=$start_date&end_date=$end_date&success=1");
    exit;
}
...
if (isset($_GET['delete_id'])) {
    ...
    header("Location: expenses_yasser.php?start_date=$start_date&end_date=$end_date&deleted=1");
    exit;
}
...
// --- 5. LOGIQUE DES SUGGESTIONS ---
// On récupère les noms de décharges déjà entrés par cet admin pour les proposer
...
<head>
    ...
    <style>
        ...
        datalist { background-color: #0f172a; color: white; }
    </style>
</head>
<body>
...
<nav class="py-3 border-bottom border-secondary mb-4" style="background: rgba(15, 23, 42, 0.9); backdrop-filter: blur(10px);">
    <div class="container d-flex justify-content-between align-items-center">
        <a href="expenses.php" class="btn btn-outline-light btn-sm rounded-pill px-4">RETOUR</a>
    ...
    <div class="row g-4">
        <div class="col-lg-4">
            <div class="glass-card shadow-lg">
                ...
                <form method="POST">
                    <div class="mb-3">
                        <label class="small fw-bold text-white-50 mb-2">NOM / TYPE (Suggestions actives)</label>
